...
//    return z0 * sigma + mu;
//};
twlobj::twlobj(uint64_t areasize,int threshold){
        ...
        this->attacktype = 0;
        interinterval = threshold*4;
        swapthreshold = threshold;
        cerr<<"twl swap"<<swapthreshold<<endl;
...
//                    sourceaddr2 = 0
    ...
    uint64_t* twlobj::access2(uint64_t addr_temp,bool iswrite){
