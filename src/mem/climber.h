 ...
 */
/* climber.h 是头文件，包含了 climberobj 类的声明。它定义了多个数据结构和成员变量，用于跟踪内存页面的寿命、访问计数等。
