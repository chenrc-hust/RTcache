...
void rt::ScariCache::delete_sc(uint64_t va)
{
    ...
    //     auto &it = SCcache[va].second;     // 对应的迭代器
    //     vst[SCcache[va].first] = false;
    //     list_.erase(it);   // 删除
    //     SCcache.erase(va); // 从map中删除
    // }
}
...
void rt::print()
{
    // std::cout << "total print RTcache" << std::endl;
    ...
    //         re_status = jt.query();
    //         total_count++;
    //         AC_num[re_status.first]++;
    //         Dis_num[re_status.second]++;
    //     }
    // }
    // std::cout << "total_count " << total_count << std::endl; // 这次遍历的数量
    //                                                          //  创建一个包含数组元素及其原始索引的向量
    // std::vector<IndexedValue> indexed_values;
    // for (size_t i = 0; i < AC_num.size(); ++i)
    // {
    //     indexed_values.push_back({AC_num[i], i});
    // }
    ...
    // std::cout << "AC_num" << std::endl;
    // for (const auto &iv : indexed_values)
    // {
    //     if (iv.value)
    //         std::cout << "Value: " << iv.value << " Percent: " << double(iv.value) / total_count << ", Original Index: " << iv.index << std::endl;
    // }
    // indexed_values.clear();
    // // 输出一个二进制的表达式，直观。

    // for (size_t i = 0; i < Dis_num.size(); ++i)
    // {
    //     indexed_values.push_back({Dis_num[i], i});
    // }
    ...
    // {
    //     if (iv.value)
    //         std::cout << "Value: " << iv.value << " Percent: " << double(iv.value) / total_count << ", Original Index: " << std::bitset<8>(iv.index) << std::endl;
    // }
    // /* 逐出情况 */
    ...
    // {
    //     away_count++;
    //     away_AC_num[it.first]++;
    //     away_Dis_num[it.second]++;
    // }
    // std::cout << "evict_tmp_count " << away_count << std::endl; // 这次遍历的数量
    //                                                             //  创建一个包含数组元素及其原始索引的向量
    // indexed_values.clear();
    // for (size_t i = 0; i < away_AC_num.size(); ++i)
    // {
    //     indexed_values.push_back({away_AC_num[i], i});
    // }
    ...
    // std::cout << "away_AC_num" << std::endl;
    // for (const auto &iv : indexed_values)
    // {
    //     if (iv.value)
    //         std::cout << "Value: " << iv.value << " Percent: " << double(iv.value) / away_count << ", Original Index: " << iv.index << std::endl;
    // }
    // indexed_values.clear();
    // // 输出一个二进制的表达式，直观。

    // for (size_t i = 0; i < away_Dis_num.size(); ++i)
    // {
    //     indexed_values.push_back({away_Dis_num[i], i});
    // }
    ...
    // std::cout << "away_Dis_num" << std::endl;
    // for (const auto &iv : indexed_values)
    // {
    //     if (iv.value)
    //         std::cout << "Value: " << iv.value << " Percent: " << double(iv.value) / away_count << ", Original Index: " << std::bitset<8>(iv.index) << std::endl;
    // }
